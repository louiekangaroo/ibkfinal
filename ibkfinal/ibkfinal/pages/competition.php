...
<head>
    ...
    <title>Itty Bitty Children Expo | Competitions</title>
...
<script>
  ...
  ga('send', 'pageview');
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav navbar-right" id="ul-menu">
                    ...
                    <li>
                        <a class="page-scroll" href="#info">Competitions</a>
                    </li>
                    <li>
    ...
    <section id="info" class="info-section">
        <div class="container divContainer">
            <h1 class="section-title">INFORMATION ABOUT SMILEY FACES COMPETITIONS</h1>
              <div class="row">
    ...
    <section id="register" class="register-section">
        <div class="container divContainer">
            <h1 class="section-title">REGISTER TO ENTER AND UPLOAD PHOTOS ONLINE</h1>
            <h4 class="column-title"></h4>
            <div class="column-div">
                        <form class="form-horizontal" id="reg-form" method = "post" action ="process_competitionimage.php" enctype="multipart/form-data">
                                
                                <div class="form-group">
                                    <label class="col-md-4 control-label" for="txtTitle">Email</label>
                                    <div class="col-md-4">
                                        <input id="txtemail" name="email" type="email" class="form-control input-md" required>
